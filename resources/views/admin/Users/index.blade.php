...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Doctor's </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url("admin/dashboard")}}">Home</a></li>
                            <li class="breadcrumb-item active">Doctor's </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="header-right" style="float: right">
                                @can('can-update')
                                <a class="btn btn-dark btn-xs " href="{{ url("get-users/add") }}">Add New</a>
                                @endcan
                            </div>
                        </div>
                        <!-- /.card-header -->
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <form method="post" action="{{ url("submit-doctors/form")}}">
                @csrf
